...
> **Bookmarked for tuning (Seth, 2026-06-09):** **zoom** (v13) is fine but wants a small tweak to feel more useful; **lateral swipe** feel proven on the bench → wired into fullscreen as v15 (tune the timing/threshold there). Pick the zoom tweak up next.
