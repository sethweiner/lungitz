...
> **Bookmarked for tuning (Seth, 2026-06-09):** **zoom** (v13) is fine but wants a small tweak to feel more useful; **lateral swipe** (haptic drag-track + keep the slide easing) is mapped but not yet built. Pick both up after arrangement.
